...
<body>
  ...
  <section class="contact-section">
    <div class="contact-container">
      <h2>BLOK-K</h2>
      <p>Hubungi admin BLOK-K melalui form di bawah ini atau melalui kontak resmi.</p>
      ...
      <form class="contact-form" action="#" method="POST">
        ...
        <div class="form-group">
          ...
          <input type="tel" id="phone" name="phone" placeholder="Masukkan no. telepon Anda" required>
        </div>
      ...
      <div class="whatsapp-btn">
        <a href="https://wa.me/6281388104378" target="_blank">💬 Hubungi via WhatsApp</a>
      </div>
      ...
      <!-- Google Maps -->
      <div class="maps">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.711819856696!2d106.78600571081498!3d-6.169329660432973!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f65c8572640d%3A0xc0a066d78372614e!2sUniversitas%20Tarumanagara!5e0!3m2!1sid!2sid!4v1759383738010!5m2!1sid!2sid" 
    ...
    <div class="footer-content">
      ...
      <div class="footer-section">
        <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 16px;">
          <img src="{{ asset('images/logo.png') }}" alt="Logo BLOK-K" style="width: 42px; height: 42px; border-radius: 10px;">
