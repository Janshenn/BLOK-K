...
<body>
  ...
  <main>
    <section class="hero" aria-labelledby="hero-title">
      <div>
        <h1 id="hero-title">Bergabunglah dengan kami untuk melatih pengalaman organisasi dan bangun portofolio anda yang
          mengesankan!</h1>
        <p class="lead">Tunjukkan karya terbaik organisasi Anda. Bangun citra profesional, raih dukungan, dan perluas
          jaringan bersama kami.</p>
        <div class="actions">
